...
var swift = new dat_gui__WEBPACK_IMPORTED_MODULE_1__.GUI();
...
var backgroundfolder = swift.addFolder("Background");
...
var wavefolder = swift.addFolder("wave");
...
var strokefolder = swift.addFolder("strokes");
...
function animate() {
  ...
  for (var i = 0; i < canvas.width; i++) {
    c.lineTo(i, wave.y + Math.sin(i * wave.length + increment) * (wave.amplitube * Math.sin(increment)));
  }
  c.strokeStyle = "hsl(".concat(Math.abs(strokecoloe.h * Math.sin(increment)), ",").concat(strokecoloe.s, "%,").concat(strokecoloe.l, "%)");
  c.stroke();
